      ...
      {option === "Option 1" && (
        <div className="flex flex-col space-y-8">
          <div className="flex space-x-4 justify-center items-center">
            <div>
              <h1 className="text-3xl font-bold mb-2">Row</h1>
              <select
            ...
            <h1 className="text-3xl font-bold  mt-10">X</h1>
            <div>
          ...
          >
            {grid.map((row, rowIndex) =>
              row.map((cell, colIndex) => (
                ...
                >
                  {colIndex === columns - 1 && (
                    <h1 className="mr-8 text-3xl font-bold text-white">=</h1>
                  )}
                  <textarea
                    onKeyPress={(e) => {
            ...
            <div className="flex flex-col space-y-4 text-amber-300">
              {results.map((result, index) => (
                <p className="text-3xl font-bold" key={index}>
                  {String.fromCharCode(120 + index)} = {result}
                </p>
              ))}
            </div>
          )}
